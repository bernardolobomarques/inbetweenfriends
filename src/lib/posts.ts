...
const posts: Post[] = [
  {
    ...
    content: `<p>In a world that constantly demands our attention, finding moments of peace can feel like a luxury. However, mindfulness is not about escaping reality but about grounding ourselves within it. It's the simple practice of being aware of the present moment, without judgment. This can be as simple as paying attention to your breath for a few minutes each day, or savoring your morning coffee without the distraction of your phone.</p><p>Start small. Dedicate five minutes each morning to a mindfulness exercise. You can use an app, or simply sit in silence. The goal isn't to clear your mind, but to observe your thoughts as they come and go, like clouds in the sky. Over time, this practice builds a foundation of inner calm that you can carry with you throughout your day. You'll find that you are more responsive and less reactive to the stresses that come your way.</p><p>Another powerful technique is the body scan meditation. Lie down comfortably and bring your attention to each part of your body, from your toes to the top of your head. Notice any sensations – warmth, tingling, tension – without needing to change them. This practice not only relaxes the body but also strengthens the mind-body connection, fostering a deeper sense of self-awareness and well-being.</p>`,
    featuredImage: 'https://placehold.co/800x600/c2a2b1/4d4545',
  ...
  },
  {
    ...
    content: `<p>Creativity is not just for artists and musicians; it is an innate human quality that we all possess. Whether it's through cooking, gardening, writing, or problem-solving, expressing our creativity is vital for a vibrant life. Often, however, the pressures of adulthood and the fear of not being "good enough" can stifle that spirit.</p><p>To unleash your creativity, you must first give yourself permission to play. Forget about the outcome and focus on the process. Doodle without purpose, dance in your living room, or write a story just for yourself. Create a dedicated space and time for your creative pursuits, no matter how small. This signals to your brain that this activity is important.</p><p>Overcoming the inner critic is perhaps the biggest challenge. When you hear that voice of self-doubt, acknowledge it, and then gently set it aside. Remind yourself that the goal is not perfection, but expression. Collaborate with others, take a class, or visit a museum to find inspiration. The more you expose yourself to new ideas and experiences, the more you will fuel your own creative fire.</p>`,
    featuredImage: 'https://placehold.co/800x600/403939/c2a2b1',

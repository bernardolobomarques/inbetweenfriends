      ...
      <main className="flex-grow">
        <section className="pt-32 pb-20 text-center bg-background">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h1 className="text-5xl md:text-7xl font-headline font-bold mb-4 animate-in fade-in slide-in-from-bottom-5 duration-700">
              Welcome to Amigas Blog
            </h1>
            <p className="max-w-3xl mx-auto text-xl text-muted-foreground mb-8 animate-in fade-in slide-in-from-bottom-5 duration-700 delay-200">
        ...
        <section className="py-20 bg-card">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-headline font-bold text-center mb-12">Latest Musings</h2>
        ...
        <section id="about" className="py-20 bg-accent text-accent-foreground">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 className="text-4xl font-headline font-bold mb-4">About the Author</h2>
